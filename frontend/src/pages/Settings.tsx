  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b bg-gray-50">
            <h2 className="text-xl font-semibold text-gray-900">Nextcloud Integration</h2>
            <p className="text-sm text-gray-600 mt-1">
              Connect to your Nextcloud instance for asset management
            </p>
          </div>
          ...
          <div className="p-6 space-y-6">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('nextcloudUrl', e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('nextcloudUsername', e.target.value)}
                placeholder="admin"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="password"
                value={formData.nextcloudPassword}
                onChange={(e) => handleInputChange('nextcloudPassword', e.target.value)}
                placeholder="••••••••"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <div>
              <label className="flex items-center gap-2">
                <input
                  type="checkbox"
                  checked={formData.nextcloudEnabled}
                  onChange={(e) => handleInputChange('nextcloudEnabled', e.target.checked)}
                  className="rounded"
                />
